...
- (void)viewDidLoad {
    ...
    //开始按钮
    UIButton *button = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width/2 - 100, self.view.frame.size.height/10*8.7, 200, 40)];
    ...
    [button setBackgroundColor:[UIColor colorWithRed:94/255.0 green:200/255.0 blue:210/255.0 alpha:1]];
...
- (void)touchBtn
{
    ...
    //进入活体检测
    RecognitionController *RC = [[RecognitionController alloc] init];
    //跳转
